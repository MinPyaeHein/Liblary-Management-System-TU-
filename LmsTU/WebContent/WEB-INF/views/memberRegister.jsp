        ...
        <div class="col-12">
          <div class="card">
			...
			<tr>
				...
				<td>${at.memberName}</td>
				<td>${at.coin}</td>
			    <td><a href="doctorDeletePath?frmDoctorId=${at.memberId}"class="btn btn-block btn-outline-primary btn-sm">Delete</a></td>
				<td><a href="doctorUpdatePath?frmDoctorId=${at.memberId}"class="btn btn-block btn-outline-primary btn-sm">Update</a></td>
			</tr>		
		</c:forEach>
                </tbody>
                <tfoot>
