            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <td>${s.index+1}</td>
				...
				<td>${at.shortTerm}</td>
				<td><a href="servicTypeDeletePath?frmServicTypeId=${at.positionId}" class="btn btn-block btn-outline-primary btn-sm">Delete</a></td>
				<td><a href="servicTypeUpdatePath?frmServicTypeId=${at.positionId}" class="btn btn-block btn-outline-primary btn-sm">Update</a></td>
                </tr>
