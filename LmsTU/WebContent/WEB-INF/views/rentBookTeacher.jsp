...
<%@ include file="/resources/admin/header/HeaderAndMainSlider.jsp" %>
  ...
  <section class="content">
    ...
    <!-- Main content -->
        ...
        <div class="card-body">
          <form:form action="rentBookTeacherSubmitPath" modelAttribute="rentReturnTeacherRegisterForm.rentReturnTeacherForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
				...
				Due Date:
                 ...
                 <form:input type="text" id="dueDate" path="dueDate" name="dueDate"  class="form-control"  data-mask="data-mask" readonly="true"/>
         		  ...
         		  <div class="form-group">
			    ${rentReturnTeacherRegisterForm.message}
         		 </div>
              <div class="form-group">
	             <div class="input-group">
	             <div class="input-group-prepend">
