...
<%@ include file="/resources/admin/header/HeaderAndMainSlider.jsp" %>
  ...
  <section class="content">
    ...
    <!-- Main content -->
        ...
        <div class="card-body">
          <form:form action="loginSubmitPath?rentlogin=rentlogin" modelAttribute="loginForm" method="POST" enctype="multipart/form-data" >
                <div class="card-body">
                <div class="row">
        	    <div class="col-md-6">
				...
				User Id :
                 ...
                 <form:input type="text" id="userId" path="userId" name="userId"  class="form-control"  data-mask="data-mask" />
                  </div>
         		 </div>
         		  <div class="form-group">
				Password :
