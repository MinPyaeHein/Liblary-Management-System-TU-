        ...
        <div class="col-12">
          <div class="card">
	        ...
	        <th>Return</th>
                ...
                <tbody>
              <c:forEach var="at" items="${rentReturnStudentRegisterForm.rentReturnStudents}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.stuRentId}</td>
				...
				<td>${at.dueDate}</td>
				<td>${at.lateFeet}</td>
				<td><a href="returnBookSubmitPath?frmStuRentId=${at.stuRentId}" class="btn btn-block btn-outline-primary btn-sm">Return</a></td>
			</tr>		
		</c:forEach>
                </tbody>
                <tfoot>
