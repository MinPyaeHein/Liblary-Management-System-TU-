  ...
  <section class="content">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col">
            <h1>Select Rent Book List for Return</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
	        ...
	        <th>Return</th>
                ...
                <tbody>
              <c:forEach var="at" items="${rentReturnTeacherRegisterForm.rentReturnTeachers}" varStatus="s">
			<tr>
				<td>${s.index+1}</td>
				<td>${at.teaRentId}</td>
				...
				<td>${at.dueDate}</td>
				<td>${at.lateFeet}</td>
				<td><a href="returnBookTeacherSubmitPath?frmTeaRentId=${at.teaRentId}" class="btn btn-block btn-outline-primary btn-sm">Return</a></td>
			</tr>		
		</c:forEach>
                </tbody>
                <tfoot>
